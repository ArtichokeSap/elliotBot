...
Agent skills are defined in `.agents/skills/` following the standard skills format.

### Session Context Skill

See `.agents/skills/session-context/SKILL.md` for the full session logging, resumption, and archival behavior.